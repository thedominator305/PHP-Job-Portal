...
$company_details = $portal->getCompanyDetails($jobs_portal_id);
        ...
        <div class="container white-shadow">
            ...
            <div class="row">
                <div class="detail-pic">
                    <img src="assets/img/com-1.jpg" class="img" alt="" />
            ...
            <div class="row bottom-mrg">
                ...
                <div class="col-md-8 col-sm-8">
                    <div class="detail-desc-caption">
                        <h4><?php echo $company_details->company; ?></h4>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="get-touch">
                        <h4>Get in Touch</h4>
                        <ul>
                            <li><i class="fa fa-map-marker"></i><span><?php echo $company_details->location; ?></span></li>
                            <li><i class="fa fa-envelope"></i><span><?php echo $company_details->email; ?></span></li>
                            <li><i class="fa fa-globe"></i><span><?php echo $company_details->website; ?></span></li>
                            <li><i class="fa fa-phone"></i><span><?php echo $company_details->phone; ?></span></li>
                            <li><i class="fa fa-users"></i><span> აქ რამეს ჩავწერთ</span></li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="full-detail-description full-detail">
        <div class="container">
            <div class="row row-bottom">
                ...
                <p><?php echo $company_details->about; ?></p>
            </div>
            <div class="row row-bottom">
