...
$job_portal_id = isset($_GET['id']) ? $_GET['id'] : null;
$jobs_portal = $portal->getJob($job_portal_id);
?>
...
<div class="wrapper">
    ...
    <section class="inner-header-title" style="background-image:url(assets/img/banner-10.jpg);">
        <div class="container">
            <h1><a href="job_company_detail.php?id=<?php echo $jobs_portal->company_id; ?>"><?php echo $jobs_portal->company; ?></a> </h1>
        </div>
    </section>
    <div class="clearfix"></div>
    <!-- Title Header End -->
        ...
        <section class="detail-desc">
            <div class="container white-shadow">
                <div class="row">
                    ...
                    <span><a href="who.php?who=<?php if(isset($jobs_portal->who)) { echo $jobs_portal->who; } ?>"><?php if(isset($jobs_portal->who)) { echo $jobs_portal->who; } ?></a> </span>
                    </div>
                </div>
                ...
                <div class="row bottom-mrg">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <div class="detail-desc-caption">
                            <h4><?php echo $jobs_portal->job_title; ?> </h4>
                            <span class="designation">Software Development Company - რას ეხება ვაკანსია კერძოდ </span>
                            <p><?php echo $jobs_portal->description; ?></p>
                            <ul>
                                <li><i class="fa fa-briefcase"></i><span class="job-type cl-success bg-trans-success"><?php echo $jobs_portal->time; ?></span></li>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="get-touch">
                            <h4>Get in Touch</h4>
                            <ul>
                                <li><i class="fa fa-map-marker"></i><span><?php echo $jobs_portal->location; ?></span></li>
                                <li><i class="fa fa-envelope"></i><span><?php echo $jobs_portal->contact_email; ?></span></li>
                                <li><i class="fa fa-globe"></i><span>microft.com</span></li>
                                <li><i class="fa fa-phone"></i><span><?php echo $jobs_portal->phone; ?></span></li>
                                <li><i class="fa fa-money"></i><span><?php echo $jobs_portal->salary; ?></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="detail pannel-footer">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="detail-pannel-footer-btn pull-right">
                                <a href="job_edit.php?id=<?php echo $jobs_portal->id; ?>" class="footer-btn grn-btn" title="">EDIT</a>
